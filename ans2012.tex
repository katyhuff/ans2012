...
\begin{align}
  ...
  &\cdot\bigintsss_0^t\!\frac{q_L(t')}{t-t'}d^{ \frac{-\left(x^2 + z^2\right)}{4\alpha (t-t')} } 
  \left[ erf\left[ \frac{1}{2} \frac{\left( y+\frac{L}{2} 
  \right)}{\sqrt{\alpha(t-t')}}  \right] \right]\,\mathrm{dt'}
  \label{line}
\end{align}
