...
This model, created at \gls{LLNL} for the \gls{UFD} campaign, is written in 
MathCAD and employs an analytical model from Carslaw and Jaeger \cite{carslaw}.
...
The central package is represented by the finite line source solution 
\eqref{finiteline}. Adjacent packages within the central tunnel are represented 
by the point source solution \eqref{point} Finally, the model uses infinite line 
source solutions (\eqref{infline} to represent adjacent disposal tunnels.
...
representing point, finite line, and infinite line source solutions in 
